...
class MonitoringService:
    ...
    def __init__(self,
        ...
        reference = reference.sample(options.reference_sample_size)
    ...
    def iterate(self, new_rows: pandas.DataFrame):
        ...
        print("Shapes", self.reference.shape, self.current.shape, self.column_mapping)
